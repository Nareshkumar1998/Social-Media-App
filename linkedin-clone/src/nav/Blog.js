...
const useStyles = makeStyles((theme) => ({
	...
	hero: {
	  backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('https://i.pinimg.com/originals/5a/15/55/5a155500a5dab6ddc6c04f4f983cddf9.gif')`,
	  height: "400px",
	   width: "800px", 
		  ...
		  <Grid container spacing={3}>
			...
			<Grid item xs={12} sm={6} md={4}>
			  <Card className={classes.card}>
				...
				<CardActions className={classes.cardActions}>
				  <Box className={classes.author}>
					<Avatar src="https://pin.dekhnews.com/wp-content/uploads/2019/09/lord-shiva-images-1.jpg" />
					<Box ml={2}>
					  <Typography variant="subtitle2" component="p">
						Jagan
					  </Typography>
			...
			<Grid item xs={12} sm={6} md={4}>
			  <Card className={classes.card}>
				...
				<CardActions className={classes.cardActions}>
				  <Box className={classes.author}>
					<Avatar src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRrvMUm5Y7_aJDKxv8_fQTbhMHaYOlevDfbzg&usqp=CAU" />
					<Box ml={2}>
					  <Typography variant="subtitle2" component="p">
						Naresh
					  </Typography>
